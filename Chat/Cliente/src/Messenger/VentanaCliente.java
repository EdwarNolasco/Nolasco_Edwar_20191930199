...
public class VentanaCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        introip.setBackground(new java.awt.Color(204, 255, 255));
        getContentPane().add(introip, new org.netbeans.lib.awtextra.AbsoluteConstraints(209, 27, 99, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(314, 27, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 68, 386, 170));

        enviartextomensaje.setBackground(new java.awt.Color(204, 255, 255));
        enviartextomensaje.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                enviartextomensajeActionPerformed(evt);
            }
        });
        getContentPane().add(enviartextomensaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 250, 281, 40));

        NickName.setBackground(new java.awt.Color(204, 255, 255));
        NickName.setText("Cliente");
        NickName.setToolTipText("");
        getContentPane().add(NickName, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 27, 76, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(321, 250, 71, 40));
